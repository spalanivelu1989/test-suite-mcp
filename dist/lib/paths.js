...
export const appTestsDir = (app) => resolve(appDir(app), "tests");
export const appRunsDir = (app) => resolve(appDir(app), "runs");
export const appConfigFile = (app) => resolve(appDir(app), "config.yaml");
export const appDescriptionFile = (app) => resolve(appDir(app), "description.md");
export const appSecretsFile = (app) => resolve(appDir(app), "secrets.local.env");
