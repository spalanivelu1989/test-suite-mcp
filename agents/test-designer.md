...
- `app_model_path` — path to `runs/<app>-<ts>/app-model.json`
- `description_path` — `apps/<app>/description.md`
- `out_dir` — `tests/<app>/generated/<category>/`
...
- Write only into `out_dir`. Do not touch other categories. Do not touch `lib/` or `tests/<app>/curated/`.
